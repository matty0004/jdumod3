...
var origin = mergeJSON(JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdb_nx.json'))), JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdbs.json'))))
var originpc = JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdb_pc.json')))
var originx1 = JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdb_xone.json')))
var originps4 = JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdb_ps4.json')))
var origincommon = JSON.parse(fs.readFileSync(path.join(__dirname, 'jdparty-all/unused/songdb_common.json')))
var pc = {}
...
var o = fs.writeFileSync(path.join(__dirname, 'jdparty-all/songdbs.json'), JSON.stringify(pc, null, 2))
}
